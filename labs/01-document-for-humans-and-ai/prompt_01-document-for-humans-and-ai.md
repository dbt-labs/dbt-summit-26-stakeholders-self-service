...
3. Document the columns a stakeholder will actually touch — the ones that appear in a filter or a sum. Column descriptions live in `models/marts/_merlinco_marts.yml`, not in the docs file you just edited. Say what they *mean*, not what type they are. You do not need to document all of them.
